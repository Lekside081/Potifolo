<template>
    <div class="py-8">
        ...
        <div class="text-blue-800 md:text-white lg:text-black">
        ...
        <div class="flex justify-center space-x-2 mt-4">
            ...
            <div class="text-3xl font-bold">+2348168807853</div>
            <div>
                <svg class="w-[36px] h-[36px] text-gray-800 dark:text-white" aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
        ...
        <div class="text-center mt-10">You may also find me on these platforms!</div>
        <div class="flex justify-center space-x-2 mt-2">
            ...
            <NuxtLink to="https://www.instagram.com/don_lekside2020/">
                <div>
                    <svg class="w-[32px] h-[32px] text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <NuxtLink
                to="https://www.linkedin.com/in/sodiq-lawal-936a762aa/?trk=li_LOL_SPIN_global_careers_jobsgtm_conv_acq_july2022_spinv1">
                <div>
                    <svg class="w-[32px] h-[32px] text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
            ...
            <NuxtLink to="https://x.com/Lekside08101">
                <div>
                    <svg class="w-[32px] h-[32px] text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
