                ...
                <div class="basis-1/6">
                    ...
                    <div class="mt-8 space-y-4 w-full px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="ml-2">78, Olowe Compound, Pananda Area, Iwo, Osun State</span>
                        </div>
                        <div class="flex justify-center mt-2">
                            <div class="basis-70 bg-gray-900 text-center py-1 text-white">LANGUAGE</div>
                        </div>
                        <div class="ml-7 text-black">
                            <li>English</li>
                        </div>
                        <div class="ml-7 text-black">
                            <li>Yoruba (fluent)</li>
                        ...
                        <div class="flex justify-center mt-4">
                            <div class="basis-70 bg-gray-900 text-center py-1 text-white">EXPERTISE</div>
                        </div>
                        <div class="space-y-1">
                            <div class="ml-7 text-black">
                                <li>Collaboration</li>
                    ...
                    <div class="w-14 h-30 -mt-24 bg-gray-300 rounded-r-full"></div>
